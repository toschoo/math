...
\chapter{Quadratics, Cubics and Quartics} % c10
%include src/c10/quadratics.lhs

\chapter{Euclid and beyond} % c11
%include src/c11/euclid.lhs

% -------------------------------------------------------------------------
\part{Analysis}
% -------------------------------------------------------------------------

\chapter{The Calculus} % c12
