...
as the second argument (|Natural -> Natural -> Natural|),
...
and, instead of |(+)|, we use |`con`|
to combine results.

From here, we can very simply define two
derived functions |convSum| and |convProduct|:
...
The |ragmen| function simply adds one to the result 
of a call to the |convSum| function defined above.
The function $f$ passed to |convSum|
and defined in the |where| clause
