...
An interesting variant of the |arith| function
...
by calling |let f = arif [1,4,7,10,13]|.
...
|[4,7,10,13,16]| and create a new $f$ from it,
we see for |map f [1..10]|:
...
\eg\ |[4,7,10,13]| to generate $f$, but apply $f$ to an odd $n$,
like this: |f 3|, the numerator is not an even number
