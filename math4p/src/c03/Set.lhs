...
We start with |ps (1:[2,3])|
and immediately continue with |ps (2:[3])|
and, in the next round, with |ps (3:[])|,
which then leads to the base case 
|ps [] = [[]]|.
On the way back,
we then have |[[]] ++ map (3:) [[]]|,
which leads to the result |[[],[3]]|.
...
we explicitly define the results |[]|
and |[0]|.
Here, |[]| means that
