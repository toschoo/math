...
Number are either rational or real. Since \ensuremath{\Varid{sqrt}\;\Varid{r}} is real,
\ie\ a \ensuremath{\Conid{Double}} in Haskell terminology, we have to convert
everything to \ensuremath{\Conid{Double}}. The result, however, shows
...
asking for numbers, instead of geormetric objects,
