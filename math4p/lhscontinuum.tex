...
Numbers are either rational or real. Since \ensuremath{\Varid{sqrt}\;\Varid{r}} is \ensuremath{\Conid{Real}},
we have to convert
everything to \ensuremath{\Conid{Real}}. The result, however, shows
