...
\\
\>[3]{}\Varid{harmonic}\;\Varid{n}\mathrel{=}\Varid{go}\;\mathrm{1}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{go}\;\Varid{i}{}\<[17]%
\>[17]{}\mid \Varid{i}\equiv \Varid{fromIntegral}\;\Varid{n}{}\<[40]%
\>[40]{}\mathrel{=}\mathrm{1}\mathbin{/}\Varid{i}{}\<[E]%
\\
\>[17]{}\mid \Varid{otherwise}{}\<[40]%
\>[40]{}\mathrel{=}\mathrm{1}\mathbin{/}\Varid{i}\mathbin{+}\Varid{go}\;(\Varid{i}\mathbin{+}\mathrm{1}){}\<[E]%
\ColumnHook
\end{pboxed}
\)\par\noindent\endgroup\resethooks
\end{minipage}
...
\ensuremath{\Varid{map}\;\Varid{harmonatural}\;[\mskip1.5mu \mathrm{1}\mathinner{\ldotp\ldotp}\mathrm{10}\mskip1.5mu]},
...
\\
\>[3]{}\Varid{pquoz}\;\Varid{n}\mathrel{=}{}\<[14]%
\>[14]{}\mathbf{let}\;{}\<[19]%
\>[19]{}\Varid{ps}\mathrel{=}\Varid{map}\;\Varid{fromIntegral}\;(\Varid{takeWhile}\;(\mathbin{<}\Varid{n})\;\Varid{allprimes}){}\<[E]%
\\
\>[19]{}\Varid{d}{}\<[22]%
\>[22]{}\mathrel{=}\Varid{fromIntegral}\;\Varid{n}{}\<[E]%
\\
\>[14]{}\mathbf{in}\;{}\<[19]%
\>[19]{}[\mskip1.5mu \Varid{d}\mathbin{/}\Varid{p}\mid \Varid{p}\leftarrow \Varid{ps}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{pboxed}
\)\par\noindent\endgroup\resethooks
\end{minipage}
...
\\
\>[3]{}\Varid{pquozavg}\;\Varid{n}\mathrel{=}{}\<[17]%
\>[17]{}\mathbf{let}\;{}\<[22]%
\>[22]{}\Varid{qs}\mathrel{=}\Varid{pquoz}\;\Varid{n}{}\<[E]%
\\
\>[22]{}\Varid{ns}\mathrel{=}\Varid{map}\;(\Varid{fromIntegral}\mathbin{\circ}\Varid{ceiling})\;\Varid{qs}{}\<[E]%
\\
\>[22]{}\Varid{ds}\mathrel{=}[\mskip1.5mu \Varid{n}\mathbin{-}\Varid{q}\mid (\Varid{n},\Varid{q})\leftarrow \Varid{zip}\;\Varid{ns}\;\Varid{qs}\mskip1.5mu]{}\<[E]%
\\
\>[17]{}\mathbf{in}\;{}\<[22]%
\>[22]{}(\Varid{sum}\;\Varid{ds})\mathbin{/}(\Varid{fromIntegral}\mathbin{\$}\Varid{length}\;\Varid{ds}){}\<[E]%
\ColumnHook
\end{pboxed}
\)\par\noindent\endgroup\resethooks
\end{minipage}
...
\ensuremath{\Varid{pquozavg}\;\mathrm{43}\mathrel{=}\mathrm{0.574161}}.
