...
\\
\>[3]{}\Varid{gamman}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
...
\\
\>[3]{}\Varid{gammal}\;\Varid{i}\;\Varid{x}\mathrel{=}(\mathrm{1}\mathbin{/}\Varid{x})\mathbin{*}\Varid{go}\;\mathrm{1}\;(\Varid{fromIntegral}\;\Varid{i}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{go}\;\Varid{n}\;\Varid{m}{}\<[19]%
\>[19]{}\mid {}\<[19E]%
\>[22]{}\Varid{n}\geq \Varid{m}{}\<[33]%
\>[33]{}\mathrel{=}{}\<[33E]%
\>[36]{}\mathrm{1}{}\<[E]%
\\
\>[19]{}\mid {}\<[19E]%
\>[22]{}\Varid{otherwise}{}\<[33]%
\>[33]{}\mathrel{=}{}\<[33E]%
\>[36]{}(\mathrm{1}\mathbin{+}\mathrm{1}\mathbin{/}\Varid{n})\mathbin{**}\Varid{x}{}\<[E]%
\\
\>[33]{}\mathbin{/}{}\<[33E]%
\>[36]{}(\mathrm{1}\mathbin{+}\Varid{x}\mathbin{/}\Varid{n}){}\<[E]%
\\
\>[33]{}\mathbin{*}{}\<[33E]%
\>[36]{}\Varid{go}\;(\Varid{n}\mathbin{+}\mathrm{1})\;\Varid{m}{}\<[E]%
\ColumnHook
\end{pboxed}
\)\par\noindent\endgroup\resethooks
\end{minipage}
...
for given iterations. When we apply \ensuremath{\Varid{gammal}} on $x=1$,
...
We try \ensuremath{\Varid{gammal}\;\mathrm{1}\;\mathrm{2}} and get 
\[
0.\overline{6}
\]
...
What about \ensuremath{\Varid{gammal}\;\mathrm{1000}\;\mathrm{2}}?
...
\\
\>[3]{}\Varid{gammae}\;\Varid{i}\;\Varid{x}\mathrel{=}\Varid{f}\mathbin{*}\Varid{go}\;\mathrm{1}\;(\Varid{fromIntegral}\;\Varid{i}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathbf{where}\;{}\<[12]%
\>[12]{}\Varid{f}\mathrel{=}\Varid{e}\mathbin{**}((\mathbin{-}\mathrm{1})\mathbin{*}\Varid{gamma}\mathbin{*}\Varid{x})\mathbin{/}\Varid{x}{}\<[E]%
\\
\>[12]{}\Varid{go}\;\Varid{n}\;\Varid{m}{}\<[20]%
\>[20]{}\mid \Varid{n}\geq \Varid{m}{}\<[33]%
\>[33]{}\mathrel{=}{}\<[33E]%
\>[36]{}\mathrm{1}{}\<[E]%
\\
\>[20]{}\mid \Varid{otherwise}{}\<[33]%
\>[33]{}\mathrel{=}{}\<[33E]%
\>[36]{}\Varid{e}\mathbin{**}(\Varid{x}\mathbin{/}\Varid{n}){}\<[E]%
\\
\>[33]{}\mathbin{*}{}\<[33E]%
\>[36]{}(\mathrm{1}\mathbin{+}(\Varid{x}\mathbin{/}\Varid{n}))\mathbin{**}(\mathbin{-}\mathrm{1}){}\<[E]%
\\
\>[33]{}\mathbin{*}{}\<[33E]%
\>[36]{}\Varid{go}\;(\Varid{n}\mathbin{+}\mathrm{1})\;\Varid{m}{}\<[E]%
\ColumnHook
...
\ensuremath{\Varid{gammae}\;\mathrm{1}\;\mathrm{1}\mathrel{=}\mathrm{0.15761774}\mathbin{...}}\\
\ensuremath{\Varid{gammae}\;\mathrm{10}\;\mathrm{1}\mathrel{=}\mathrm{0.82120772}\mathbin{...}}\\
\ensuremath{\Varid{gammae}\;\mathrm{100}\;\mathrm{1}\mathrel{=}\mathrm{0.98022710}\mathbin{...}}\\
\ensuremath{\Varid{gammae}\;\mathrm{1000}\;\mathrm{1}\mathrel{=}\mathrm{0.99799833}\mathbin{...}}
...
\ensuremath{\Varid{gammal}\;\mathrm{1000}\;\mathrm{0.5}\mathbin{*}\Varid{gammal}\;\mathrm{1000}\;\mathrm{0.5}\mathrel{=}\mathrm{3.14237736}\mathbin{...}}
