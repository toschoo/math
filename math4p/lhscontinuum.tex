...
\\
\>[3]{}\Varid{simplify}\;(\Conid{R}\;\Varid{a}\;\Varid{e})\mid \Varid{e}\mathbin{>}\mathrm{0}\mathrel{\wedge}{}\<[E]%
\\
\>[3]{}\hsindent{19}{}\<[22]%
...
\>[22]{}\mid \Varid{i}\equiv \Varid{e}{}\<[32]%
\>[32]{}\mathrel{=}\Conid{R}\;\Varid{r}\;\Varid{e}{}\<[E]%
\\
\>[22]{}\mid \Varid{e}\mathbin{<}{}\<[29]%
\>[29]{}\Varid{i}{}\<[32]%
\>[32]{}\mathrel{=}\Varid{blowup}\;\Varid{i}\;(\Conid{R}\;(\mathrm{10}\mathbin{*}\Varid{r})\;(\Varid{e}\mathbin{+}\mathrm{1})){}\<[E]%
\\
\>[22]{}\mid \Varid{e}\mathbin{>}{}\<[29]%
\>[29]{}\Varid{i}{}\<[32]%
\>[32]{}\mathrel{=}\Varid{error}\;\text{\tt \char34 cannot~blowup~down\char34}{}\<[E]%
\ColumnHook
\end{pboxed}
\)\par\noindent\endgroup\resethooks
...
\>[40]{}\mathrel{=}\Conid{R}\;(\Varid{a}\mathbin{+}\Varid{b})\;\Varid{e1}{}\<[E]%
\\
\>[26]{}\mid {}\<[26E]%
...
\>[15]{}\mid \Varid{a}\mathbin{>}\Varid{b}{}\<[28]%
\>[28]{}\mathrel{=}{}\<[28E]%
\>[31]{}(\Varid{a},\mathrm{0}){}\<[E]%
\\
\>[15]{}\mid \Varid{otherwise}{}\<[28]%
\>[28]{}\mathrel{=}{}\<[28E]%
\>[31]{}\mathbf{let}\;(\Varid{x},\Varid{e})\mathrel{=}\Varid{borrow}\;(\mathrm{10}\mathbin{*}\Varid{a})\;\Varid{b}{}\<[E]%
\\
\>[31]{}\mathbf{in}\;(\Varid{x},\Varid{e}\mathbin{+}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
...
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathbf{where}\;{}\<[12]%
\>[12]{}\Varid{go}\;\mathrm{0}\;\anonymous \;\anonymous \mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[12]{}\Varid{go}\;\Varid{i}\;\Varid{x}\;\Varid{y}\mathrel{=}\mathbf{case}\;\Varid{x}\mathbin{`\Varid{quotRem}`}\Varid{y}\;\mathbf{of}{}\<[E]%
\\
\>[12]{}\hsindent{13}{}\<[25]%
\>[25]{}(\Varid{q},\mathrm{0})\to \mathrm{10}\mathbin{\uparrow}\Varid{i}\mathbin{*}\Varid{q}{}\<[E]%
\\
\>[12]{}\hsindent{13}{}\<[25]%
\>[25]{}(\Varid{q},\Varid{r})\to \mathbf{let}\;{}\<[39]%
\>[39]{}(\Varid{r'},\Varid{e}){}\<[47]%
\>[47]{}\mathrel{=}\Varid{borrow}\;\Varid{r}\;\Varid{y}{}\<[E]%
\\
\>[39]{}\Varid{q'}{}\<[47]%
\>[47]{}\mathrel{=}\mathrm{10}\mathbin{\uparrow}\Varid{i}\mathbin{*}\Varid{q}{}\<[E]%
\\
\>[25]{}\hsindent{9}{}\<[34]%
\>[34]{}\mathbf{in}\;\mathbf{if}\;\Varid{e}\mathbin{>}\Varid{i}\;{}\<[47]%
\>[47]{}\mathbf{then}\;\Varid{q'}{}\<[E]%
\\
\>[47]{}\mathbf{else}\;\Varid{q'}\mathbin{+}\Varid{go}\;(\Varid{i}\mathbin{-}\Varid{e})\;\Varid{r'}\;\Varid{y}{}\<[E]%
\\[\blanklineskip]%
\>[3]{}\Varid{r2d}\mathbin{::}\Conid{RealN}\to \Conid{Double}{}\<[E]%
\\
\>[3]{}\Varid{r2d}\;\Varid{r}\mathord{@}(\Conid{R}\;\Varid{a}\;\Varid{e}){}\<[18]%
\>[18]{}\mid \Varid{e}\mathbin{>}\mathrm{17}{}\<[31]%
\>[31]{}\mathrel{=}\Varid{r2d}\;(\Varid{roundr}\;\mathrm{17}\;\Varid{r}){}\<[E]%
\\
